  ...
  renderText = () => {
    return (
      <Cell>
        ...
        <CellBody>
          <TextInputTypeProvider value={this.state.text}>
            {(props: any) => (
              <TextInput
                {...props}
                clear
  ...
  renderBankCard = () => {
    return (
      <Cell access>
        ...
        <CellBody>
          <TextInputTypeProvider type="bankCard" value={this.state.bankCard}>
            {(props: any) => (
              <TextInput
                {...props}
                clear
  ...
  renderPhone = () => {
    return (
      <Cell>
        ...
        <CellBody>
          <TextInputTypeProvider type="phone" value={this.state.phone}>
            {(props: any) => (
              <TextInput
                {...props}
                clear
  ...
  renderPassword = () => {
    return (
      <Cell>
        ...
        <CellBody>
          <TextInputTypeProvider type="password" value={this.state.password}>
            {(props: any) => (
              <TextInput
                {...props}
                clear
  ...
  renderNumber = () => {
    return (
      <Cell access error>
        ...
        <CellBody>
          <TextInputTypeProvider type="number" value={this.state.number}>
            {(props: any) => (
              <TextInput
                {...props}
                clear
