...
export interface TextInputTypeProviderProps
  extends TextInputTypeProviderType,
    TextInputProperties {}

export default class TextInputTypeProvider extends React.Component<
  TextInputTypeProviderProps,
  any
> {
  static defaultProps = {
    type: 'text',
  ...
  render() {
    const { type, value: originValue, children, ...restProps } = this.props
