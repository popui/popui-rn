...
| onChange    |  callback that is called when the user taps a segment; passes the event object as an argument. `eEvent.selectedSegmentIndex` is selected index. `eEvent.value` is selected value. | (e): void |  function(){}  |
